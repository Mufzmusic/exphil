const allQuestions = [
    ...
    {
        question: "Hva kjennetegner en 'teologisk' forklaring?",
        options: [
        ...
        answer: 1,
        feedback: "En teologisk forklaring søker å forklare fenomener ut fra formål eller mål, snarere enn kun årsak."
    },
    {
    ...
    {
        question: "Hvordan beskriver Thomas Hobbes 'naturtilstanden'?",
        options: [
            "En fredelig tilstand der alle mennesker samarbeider om ressurser", 
            "En hypotetisk tilstand uten styring hvor 'alles kamp mot alle' rår", 
            "En tilstand hvor naturlovene styrer og beskytter alle individer", 
            "En situasjon der kun den sterkeste har moralsk rett"
        ],
        answer: 1,
        feedback: "Hobbes beskrev naturtilstanden som en hypotetisk tilstand uten styring, preget av 'alles kamp mot alle'."
    },
    {
    ...
    {
        question: "Hva mente Karl Popper med 'falsifikasjon' som demarkasjonskriterium?",
        options: [
            "At teorier bør kun støttes av empiri og ikke kan motbevises", 
            "At en vitenskapelig teori må kunne avkreftes for å være gyldig", 
            "At kun matematiske teorier kan regnes som vitenskap", 
            "At alle teorier er sanne til de bevises feil"
        ],
        answer: 1,
        feedback: "Popper mente at vitenskapelige teorier må være falsifiserbare, altså at det må være mulig å motbevise dem, for at de skal regnes som vitenskapelige."
    },
    {
    ...
    {
        question: "Hva går Poppers falsifikasjonskriterium ut på?",
        options: [
            "At en teori er vitenskapelig hvis den kan bekreftes av observasjoner", 
            "At en teori må kunne avkreftes for å være vitenskapelig gyldig", 
            "At kun objektive sannheter kan regnes som vitenskapelige", 
            "At alle teorier må være fullstendig bevist før de kan godtas"
        ],
        answer: 1,
        feedback: "Popper mente at en teori må kunne falsifiseres, eller motbevises, for å være vitenskapelig."
    },
    {
        question: "Hva innebærer Quine-Duhem-tesen for hypotesetesting?",
        options: [
            "At hypoteser kan testes uavhengig av hverandre", 
            "At en hypotese aldri kan testes i isolasjon, men sammen med andre teorier", 
            "At vitenskapelige tester alltid er objektive", 
            "At testing kun er relevant for teoretiske spørsmål"
        ],
        answer: 1,
        feedback: "Quine-Duhem-tesen antyder at hypoteser alltid testes i sammenheng med andre antagelser, noe som utfordrer enkel falsifikasjon."
    },
    {
        question: "Hvordan beskriver Kuhn en vitenskapelig revolusjon?",
        options: [
            "En gradvis utvikling innenfor det samme paradigmet", 
            "En disruptiv overgang fra ett paradigme til et fundamentalt nytt rammeverk", 
            "En kontinuerlig og lineær forbedring av eksisterende teorier", 
            "En enkel revisjon av detaljer i etablerte teorier"
        ],
        answer: 1,
        feedback: "Ifølge Kuhn innebærer en vitenskapelig revolusjon en overgang til et helt nytt paradigme når det gamle paradigmet blir utilstrekkelig."
    },
    {
        question: "Hva betyr 'teoriavhengighet av observasjon'?",
        options: [
            "At observasjoner kan endre teoriene uten kontekst", 
            "At observasjoner påvirkes av eksisterende teorier og begreper", 
            "At observasjoner alltid er nøyaktige og ikke påvirkes av hypoteser", 
            "At all observasjon er irrelevant for vitenskapelig teori"
        ],
        answer: 1,
        feedback: "Teoriavhengighet av observasjon innebærer at våre teorier og begreper former hvordan vi oppfatter og tolker observasjoner."
    },
    {
    ...
    {
        question: "Hvordan kan hypotetisk-deduktiv metode brukes i vitenskapen?",
        options: [
            "For å observere hendelser uten å formulere hypoteser", 
            "For å dedusere testbare prediksjoner fra en hypotese", 
            "For å bevise teorier uten empirisk testing", 
            "For å unngå falsifisering ved å endre eksperimenter"
        ],
        answer: 1,
        feedback: "Hypotetisk-deduktiv metode brukes til å teste hypoteser ved å dedusere forutsigelser som kan bekreftes eller avkreftes."
    },
    {
    ...
    },
    {
        ...
        options: [
            ...
            "Vitenskapelige hypoteser må kunne verifiseres eller bekreftes, og hypotesene bør være dristige og vidtrekkende.",
